...
import com.faesa.app.dao.EsporteDAOMongo;
...
{
    private static final EsporteDAOMongo esporteDao = new EsporteDAOMongo(); //EsporteDAOOracle();
    ...
    public static Esporte findByUId(String uid)
    {
        try {
            return esporteDao.selectByUId(uid);
        }
        catch(Exception e) {

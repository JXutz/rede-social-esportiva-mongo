...
public class AppEvento extends App
{
    ...
    public String inserirRegistros()
    {
        ...
        Evento e = new Evento(null, esporte.getUid(), nome, desc, dt, local, null, esporte);
    ...
    public static Evento scanEvento()
    {
        ...
        while(true)
        {
            String iEvento = ScannerUtil.scanString("> Esporte (ID): ", true);

            int index = 0;
            try {
                index = Integer.parseInt(iEvento) - 1;
            }
            catch(NumberFormatException e) {
                System.out.println("ID invalido.");
                continue;
            ...
            try {
	            ...
	            if(EventoController.findByUId(e.getUid()) != null)
	                return e;
            }
    ...
    public String removerRegistros()
    {
        ...
        */
    	...
    	Evento e = scanEvento();
    	if(e != null) {
	    	if(EventoController.delete(e.getUid())) {
	    		System.out.println("Evento removido com sucesso.");
	    	}
	    	else
	    		System.out.println("Houve um problema ao tentar deleter o Evento");
    	}
